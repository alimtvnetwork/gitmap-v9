...
**Example:** `git@github.com:alimtvnetwork/gitmap-v8.git`
→ `slug = "gitmap-v8"` → `base = "gitmap"`, `K = 7`.
...
replace: src/foo.go: 3 matches (gitmap-v4 → gitmap-v8)
replace: docs/setup.md: 1 match (gitmap-v8 → gitmap-v8)
...
